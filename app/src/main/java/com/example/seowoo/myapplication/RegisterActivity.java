...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int genderGroupID = genderGroup.getCheckedRadioButtonId(); //남자인지 여자인지 판별하는 아이디
        userGender = ((RadioButton)findViewById(genderGroupID)).getText().toString(); // 남성 또는 여성의 값
                            ...
                            try
                            {
                                ...
                                if(success){
                                    ...
                                    dialog = builder.setMessage("회원 등록에 성공하였습니다.")
                                            .setPositiveButton("확인", null).setOnDismissListener(new DialogInterface.OnDismissListener() {
                                                @Override
    ...
    //RegisterActivity가 종료될 때 실행되는 메소드
    @Override
    protected void onStop(){
        super.onStop();

        if (dialog != null) // 이게 무엇일까?
        {
            dialog.dismiss(); // 이것은?
            dialog = null;
        }
